...
//            int testcases = 1;
            while (testcases-- > 0) {
                ...
                String s = "meow";
                String comp = ""+given.charAt(0);
                char prev = comp.charAt(0);
                int i = 0;
                while (i<given.length()){
                    if (given.charAt(i)==prev)i++;
                    else {
                        comp+=given.charAt(i);
                        prev = given.charAt(i);
                    }
                ...
                boolean ok = true;
                if (comp.length()!=4) ok = false;
                for (int j = 0; j < comp.length() && comp.length()==4; j++) {
                    if (comp.charAt(j)!=s.charAt(j)){
                        ok = false;
                        break;
                    }
                }
