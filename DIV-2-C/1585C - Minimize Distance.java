...
//                             int testcases = 1;
            ...
            while (testcases-- > 0) {
                ...
                long cost =0;
                long maxi =0;
                long start = neg.isEmpty()?0: abs(neg.get(0));
                for (int i = 0; i < neg.size(); i++) {
                    ...
                    maxi = max(maxi,abs(neg.get(i)));
                }
                cost+=start;
                size = 0;
                start = poss.isEmpty()?0:poss.get(poss.size()-1);
                for (int i = poss.size()-1; i >=0 ; i--) {
                    ...
                    maxi = max(maxi,poss.get(i));
                }
                cost+=start;


                out.println((2*cost)-maxi);
                // ---------------------------------------------------
            }
            out.close();
        } catch (Exception e) {
