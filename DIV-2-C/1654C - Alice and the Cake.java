...
//            int testcases = 1;
            while (testcases-- > 0) {
                ...
                if (isPos(sum,map))out.println("YES");
                else out.println("NO");
    ...
    private static boolean isPos(long sum, HashMap<Long,Integer> map){
        ...
        long p1 = (long) ceil((sum*1.0)/2);
        long p2 = (long) floor((sum*1.0)/2);
        return isPos(p1,map) && isPos(p2,map);
    }
