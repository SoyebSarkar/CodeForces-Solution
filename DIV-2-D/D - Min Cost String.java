...
public class Main {
        ...
        static boolean[] track = new boolean[26];
...
//            int testcases = in.nextInt();
            ...
            while (testcases-- > 0) {
                ...
                track = new boolean[26];
                dfs(n,0);
                n++;
                int len = str.length();
                if (n<len)out.println(str.substring(0,n));
                else {

                    StringBuilder ans = new StringBuilder(str.toString());
                    while (ans.length()< n)ans.append(str.substring(1));
                    out.println(ans.substring(0,n));
                }
